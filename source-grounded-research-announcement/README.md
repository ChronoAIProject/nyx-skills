...
**Mirrored from [Ornn](https://ornn.chrono-ai.fun/skills/source-grounded-research-announcement) — read-only.**

Edits here are NOT propagated back. Submit changes on Ornn.

- Latest version: `0.1`
- Last synced: `2026-07-15T09:00:01.087Z`

## Install

```bash
npx skills add ChronoAIProject/nyx-skills/source-grounded-research-announcement
```
