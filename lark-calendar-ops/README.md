...
**Mirrored from [Ornn](https://ornn.chrono-ai.fun/skills/lark-calendar-ops) — read-only.**

Edits here are NOT propagated back. Submit changes on Ornn.

- Latest version: `1.1`
- Last synced: `2026-06-26T15:00:03.433Z`

## Install

```bash
npx skills add ChronoAIProject/ornn-skills/lark-calendar-ops
```
