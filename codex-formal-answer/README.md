...
**Mirrored from [Ornn](https://ornn.chrono-ai.fun/skills/codex-formal-answer) — read-only.**

Edits here are NOT propagated back. Submit changes on Ornn.

- Latest version: `0.1`
- Last synced: `2026-09-12T11:00:09.254Z`

## Install

```bash
npx skills add ChronoAIProject/nyx-skills/codex-formal-answer
```
