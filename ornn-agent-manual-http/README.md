...
**Mirrored from [Ornn](https://ornn.ornn-cluster.local/skills/ornn-agent-manual-http) — read-only.**

Edits here are NOT propagated back. Submit changes on Ornn.

- Latest version: `1.0`
- Last synced: `2026-05-23T18:00:00.054Z`

## Install

```bash
npx skills add ChronoAIProject/ornn-skills/ornn-agent-manual-http
```
