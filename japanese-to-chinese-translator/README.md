...
**Mirrored from [Ornn](https://ornn.chrono-ai.fun/skills/japanese-to-chinese-translator) — read-only.**

Edits here are NOT propagated back. Submit changes on Ornn.

- Latest version: `0.1`
- Last synced: `2026-06-26T02:00:03.564Z`

## Install

```bash
npx skills add ChronoAIProject/ornn-skills/japanese-to-chinese-translator
```
