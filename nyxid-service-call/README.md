...
**Mirrored from [Ornn](https://ornn.chrono-ai.fun/skills/nyxid-service-call) — read-only.**

Edits here are NOT propagated back. Submit changes on Ornn.

- Latest version: `1.1`
- Last synced: `2026-07-17T20:00:02.406Z`

## Install

```bash
npx skills add ChronoAIProject/nyx-skills/nyxid-service-call
```
