...
**Mirrored from [Ornn](https://ornn.chrono-ai.fun/skills/chatgpt-image-short-video) — read-only.**

Edits here are NOT propagated back. Submit changes on Ornn.

- Latest version: `0.1`
- Last synced: `2026-07-18T07:00:02.742Z`

## Install

```bash
npx skills add ChronoAIProject/nyx-skills/chatgpt-image-short-video
```
