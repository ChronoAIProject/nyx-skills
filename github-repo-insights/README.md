...
**Mirrored from [Ornn](https://ornn.chrono-ai.fun/skills/github-repo-insights) — read-only.**

Edits here are NOT propagated back. Submit changes on Ornn.

- Latest version: `1.0`
- Last synced: `2026-09-06T19:00:48.497Z`

## Install

```bash
npx skills add ChronoAIProject/nyx-skills/github-repo-insights
```
